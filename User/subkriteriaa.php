        ...
        <div class="container-fluid px-4">
            <h1 class="mt-4">Data Subkriteria</h1>
                ...
                <div class="card">
                    ...
                    <a href="<?= $main_url ?>user/add-subkriteria.php" class="btn btn-sm btn-primary float-end"><i class="fa-solid fa-square-plus"></i> Tambah subkriteria</a>
                    </div>
                    <div class="card-body">
                                ...
                                <?php
                                 if (isset($_GET['id_kriteria']) && !empty($_GET['id_kriteria'])) {
                                    ...
                                    <?php }
                                        ...
                                        echo "<tr><td colspan='4' align='center'>Tidak ada subkriteria ditemukan.</td></tr>";
                                    }
                                } else {
                                    echo "<tr><td colspan='4' align='center'>Tidak ada kriteria yang dipilih.</td></tr>";
                                } ?>
                            </tbody>
                        </table>
                    </div>
