...
$title = "Tambah User - Ponpes Al Asror";
...
if ($msg == 'updated') {
    ...
    <i class="fa-solid fa-check"></i> Gantp Password Berhasil...
...
if ($msg == 'err2') {
    $alert = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
    <i class="fa-solid fa-xmark"></i> Ganti Password Gagal, Password Lama Tidak Cocok...
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>';
}
        ...
        <div class="container-fluid px-4">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <button type="reset" name="reset" class="btn btn-danger float-end me-1"><i class="fa-solid fa-xmark"></i> Riset</button>
                </div>
                <div class="card-body">
                    <div class="mb-3 row">
                        <div class="col-7">
