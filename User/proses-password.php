...
if (isset($_POST['simpan'])) {
    ...
    $queryUser = mysqli_query($koneksi, "SELECT * FROM tabel_user WHERE username = '$userName'");
    ...
    if (!password_verify($curPass, $data['password'])) {
        ...
        mysqli_query($koneksi, "UPDATE tabel_user SET password ='$pass' WHERE username = '$userName'");
